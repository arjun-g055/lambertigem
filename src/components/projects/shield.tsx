...
export default function ProjectBox() {
  return (
    <div className="relative flex flex-col items-center">
      ...
      <a
        href="https://2024.igem.wiki/lambert-ga"
        target="_blank"
      ...
      >
        ...
        <img
          src="https://gbditp38bksey5gu.public.blob.vercel-storage.com/projects/shield-hover.png"
          alt="Shield 2024 Description"
          className="
            absolute inset-0
            h-48
            w-auto
